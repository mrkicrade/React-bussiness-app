...
const HeroComponent = () => {
  return (
    <div className='container mx-auto mt-[59px]'>
      <h1 className='text-[48px] text:mainBlue dark:text-white text-center lg:w-[80%] mx-auto'>We are creative agency capable of creating outstanding designs and websites</h1>
      <p className='text:mainGray dark:text-white text-[16px] text-center mt-[53px]'>With Immodev Reach more customers and grow your business potential online by building a website with us</p>
